...
Assignment 2:
 ...
 1. Update the name of test suite by adding you name: “This is first test suite, Asja Dorofejeva”
...
describe('This is first test suite, Asja Dorofejeva', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        // 25.04.2025
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('input[name="firstName"]').type('asja')
    ...
    it('User can use only same both first and validation passwords', () => {
        ...
        cy.get('input[name="password"]').type('newpassword')
        cy.get('[name="confirm"]').type('newnewpassword')
